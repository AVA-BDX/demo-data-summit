...
path_responses = r"other_data/qna_data_bases/reponses_bot_augmente.csv"
data_base = pd.read_csv(path_responses,  sep=";", encoding="utf-8")       
...
with open('other_data/qna_data_bases/strored_all_bot_responses.txt', 'w') as outfile:
    json.dump(strored_all_bot_responses, outfile)
    
    
path_question = r"other_data/qna_data_bases/questions_bot_augmente.csv"
data_base = pd.read_csv(path_question,  sep=";", encoding="utf-8")    
...
with open('other_data/qna_data_bases/strored_all_bot_questions.txt', 'w') as outfile:

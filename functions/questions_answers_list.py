...
with open('other_datadata/qna_data_bases/strored_all_bot_responses.txt', 'w') as outfile:
    json.dump(strored_all_bot_responses, outfile)
    
    
path_question = r"other_datadata/qna_data_bases/questions_bot_augmente.csv"
...
with open('other_datadata/qna_data_bases/strored_all_bot_questions.txt', 'w') as outfile:
